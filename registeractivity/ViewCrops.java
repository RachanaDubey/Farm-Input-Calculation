...
public class ViewCrops extends AppCompatActivity {
    ...
    private static final String URL_PRODUCTS = "http://192.168.1.6/FIC/trendy_crops.php";

    //a list to store all the products
    List<Crops> productList;
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                productList.add(new Crops(
                                        product.getString("quantity"),
                                        product.getString("crop")
                                ));
                                count1.setText("Total crops used: "+array.length());
                            }
                            //creating adapter object and setting it to recyclerview
                            CropsCustomAdapter adapter = new CropsCustomAdapter(ViewCrops.this, productList);
